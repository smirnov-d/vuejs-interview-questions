...
|21 | [What are components and give an example?](#what-are-components-and-give-an-example)|
|22 | [What are props?](#what-are-props)|
|23 | [When component needs a single root element?](#when-component-needs-a-single-root-element)|
|24 | [How do you communicate from child to parent using events?](#how-do-you-communicate-from-child-to-parent-using-events)|
|25 | [How do you implement model on custom input components?](#how-do-you-implement-model-on-custom-input-components)|
|26 | [What are slots?](#what-are-slots)|
|27 | [What is global registration in components?](#what-is-global-registration-in-components)|
|28 | [Why do you need local registration?](#why-do-you-need-local-registration)|
|29 | [What are single file components?](#what-are-single-file-components)|
|30 | [What are filters?](#what-are-filters)|
|31 | [What is Dev Tools and its purpose?](#what-is-dev-tools-and-its-purpose)|
|32 | [What is the browser support of VueJS?](#what-is-the-browser-support-of-vuejs)|
|33 | [How do you use various CDNs?](#how-do-you-use-various-cdns?)|
|34| [How do you use hot reloading?](#how-do-you-use-hot-reloading)|
|35| [What is the main difference between method and computed property?](#what-is-the-main-difference-between-method-and-computed-property)|
